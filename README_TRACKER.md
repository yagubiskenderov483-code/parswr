...
моментально ловит новые листинги в диапазоне **5–15 TON** (~490–1471⭐)
и постит карточки в твой канал — с кнопками
...
- Новые лоты, попавшие в диапазон `MIN_TON..MAX_TON` (по умолчанию 5–15 TON), уходят в канал.
...
| `MIN_TON` / `MAX_TON` | диапазон цены в TON, по умолчанию 5–15 |
...
|---|---|---|
| `POLL_INTERVAL` | 2 | пауза между проходами, сек |
| `PAGE_LIMIT` | 12 | свежих лотов на коллекцию за проход |
