...
std::optional<int> CGraphicsBackend_EGL::ShowMessageBox(const IGraphics::CMessageBox &MessageBox)
{
	log_error("gfx/egl", "Unhandled message box: %s: %s", MessageBox.m_pTitle, MessageBox.m_pMessage);
	return std::nullopt;
}
